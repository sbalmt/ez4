...
export declare class TestTopic1 extends Topic.Unordered<TestUnionMessage> {
  subscriptions: [
...
export declare class TestTopic2 extends Topic.Unordered<TestIntersectionMessage> {
  subscriptions: [
    Topic.UseSubscription<{

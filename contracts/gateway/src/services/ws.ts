...
export namespace Ws {
  ...
  export type Listener<T extends Request | Http.AuthRequest> = HttpListener<T>;
  export type Handler<T extends Request> = WsHandler<T>;
  ...
  export type ServiceEvent<T extends Request | Http.AuthRequest = Request> = CommonService.AnyEvent<Incoming<T>>;

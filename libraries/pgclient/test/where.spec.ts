...
describe('where', () => {
  ...
  it('assert :: prepare where (is in)', () => {
    ...
    deepEqual(variables, ['00000000-0000-1000-9000-000000000000', '00000000-0000-1000-9000-000000000001']);
  });
  ...
  it('assert :: prepare where (and/or)', () => {
    ...
    deepEqual(variables, [123, '00000000-0000-1000-9000-000000000000', 456, 789]);
  });

# Hello: AWS ElastiCache

This example showcases how to set and use ElastiCache.
...
> This action will run a local version of the project using the remote cache.

```sh
npm run serve -- --local
```

> This action will run a local version of the project using the local cache.

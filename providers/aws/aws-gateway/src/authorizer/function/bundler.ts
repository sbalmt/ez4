...
export const bundleApiFunction = async (dependencies: EntryState[], parameters: AuthorizerFunctionParameters) => {
  const { extras, debug, authorizer, listener, headersSchema, parametersSchema, querySchema } = parameters;

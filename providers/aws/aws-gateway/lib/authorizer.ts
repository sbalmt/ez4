...
const onBegin = (request: Partial<IncomingRequest>) => {
  return dispatch(
    {
...
const onReady = (request: Partial<IncomingRequest>) => {
  return dispatch(
    {
...
const onDone = (request: Partial<IncomingRequest>) => {
  return dispatch(
    {
...
const onEnd = (request: Partial<IncomingRequest>) => {
  return dispatch(
    {
